...
class ColorManager {
  // Primary Colors
  static const Color primary = Color(0xff520C0C);
  static const Color darkPrimary = Color(0xff3B0707);
  static const Color lightPrimary = Color(0xff872020); // color with 80% opacity
